"""
Otsu thresholding segmentation plugin.
...
class OtsuSegmentation(SegmentationPlugin):
    """
    Otsu thresholding segmentation plugin.
    ...
    def __init__(self, nbins: int = 256, **kwargs):
        """
        Initialize Otsu segmentation plugin.
    ...
    def description(self) -> str:
        ...
        return (
            "Otsu's automatic threshold selection method for binary segmentation. "
